...
def start(totalnum,initialdistance,array,threshold,realdistance,total_distance,velocity_):
    #global up,down
...
tk.Button(framer, text='开始', command=lambda: start(totalnum,initialdistance,array,threshold,real_distance,total_distance,velocity,)).pack(side='left')
...
tk.Button(framer, text='绘图', command=lambda: draw_array(fig,canvas,)).pack(side='left')
